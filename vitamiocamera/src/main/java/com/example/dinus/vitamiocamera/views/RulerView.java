...
public class RulerView extends View {
    ...
    private final String DEFAULT_RULDER_UNIT_COLOR          = "#ffffffff";
    ...
    private void init() {
        ...
        textWidth = textPaint.measureText(String.valueOf(rulerMaxValue).concat(":"));
    ...
    private float getSuggestMinimumHeight() {
        return textSize + scaleIntervalHeight + textSize / 3;
    }
