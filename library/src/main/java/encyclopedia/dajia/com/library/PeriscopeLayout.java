package encyclopedia.dajia.com.library;
...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        Drawable red = getResources().getDrawable(R.drawable.ic_leaf);
        Drawable yellow = getResources().getDrawable(R.drawable.ic_leaf);
        Drawable blue = getResources().getDrawable(R.drawable.ic_leaf);
